...
Route::get('/finish/{tracation_id}', 'HomeController@finish');
Route::get('/sorteios', 'HomeController@sorteios');
Route::get('/consultaPIX/{tracation_id}', 'HomeController@consultaPIX')->name('pay.consulta-pix');
Route::post('/qrcode', 'HomeController@qrcode')->name('pay.qrcode');
...
Route::middleware(['validaLogado'])->group(function () {
	...
	Route::get('/refresh', 'PagamentoController@refresh')->name('pagamentos.refresh');
	...
	Route::get('/kind/{id}', 'RifaController@kind')->name('rifas.kind');
	Route::put('/kind-save/{id}', 'RifaController@kindSave')->name('rifas.kind-save');
